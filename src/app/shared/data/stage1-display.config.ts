...
export const STAGE1_ALL_LABELS: Record<string, string> = {
  ...
  climateTrackRecord: "Climate-related Projects Track Record (3.1.4)",
  intendedESSRiskCategory: "Intended ESS Risk Category (3.1.5)",
  intendedFinancialInstruments: "Intended Financial Instruments (3.1.6)",
  ...
  hasSubmittedFMCA: "Submitted FMCA? (3.4)",
...
const VALUE_LABELS: Record<string, Record<string, string>> = {
  organizationType: {
    ...
    "self-nominating-international":
      "Self-nominating international access entity",
  },
  nominationLetterAttached: {
    yes: "Yes, attached",
    later: "Will submit later",
  },
  consultationMode: {
    email: "Email",
  ...
  intendedESSRiskCategory: {
    "category-a": "Category A/Intermediation 1",
    "category-b": "Category B/Intermediation 2",
    "category-c": "Category C/Intermediation 3",
  },
  intendedFinancialInstruments: {
    "grant": "Grant",
    "non-grant": "Non-grant",
  },
};
...
export const STAGE1_DISPLAY_SECTIONS: DisplaySection[] = [
  {
    ...
    fields: [
      ...
      {
        key: "nominationLetterAttached",
        label: STAGE1_ALL_LABELS["nominationLetterAttached"],
      },
      {
        key: "ndaEngagementDescription",
        label: STAGE1_ALL_LABELS["ndaEngagementDescription"],
      },
      {
        key: "consultationCountry",
        label: STAGE1_ALL_LABELS["consultationCountry"],
      },
      {
        key: "consultationContactPerson",
        label: STAGE1_ALL_LABELS["consultationContactPerson"],
      },
      { key: "consultationMode", label: STAGE1_ALL_LABELS["consultationMode"] },
      {
        key: "consultationDates",
        label: STAGE1_ALL_LABELS["consultationDates"],
      },
      ...
      {
        key: "consultationSummary",
        label: STAGE1_ALL_LABELS["consultationSummary"],
      },
      {
        key: "nominationLetterFiles",
        label: STAGE1_ALL_LABELS["nominationLetterFiles"],
      },
      {
        key: "consultationSummaryFiles",
        label: STAGE1_ALL_LABELS["consultationSummaryFiles"],
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: "legalAddress", label: STAGE1_ALL_LABELS["legalAddress"] },
      {
        ...
        label: STAGE1_ALL_LABELS["operationalAddress"],
      },
      { key: "website", label: STAGE1_ALL_LABELS["website"] },
      {
        key: "primaryContactName",
        label: STAGE1_ALL_LABELS["primaryContactName"],
      },
      {
        key: "primaryContactEmail",
        label: STAGE1_ALL_LABELS["primaryContactEmail"],
      },
      {
        key: "primaryContactPhone",
        label: STAGE1_ALL_LABELS["primaryContactPhone"],
      },
      {
        key: "secondaryContactName",
        label: STAGE1_ALL_LABELS["secondaryContactName"],
      },
      {
        key: "secondaryContactEmail",
        label: STAGE1_ALL_LABELS["secondaryContactEmail"],
      },
      {
        key: "secondaryContactPhone",
        label: STAGE1_ALL_LABELS["secondaryContactPhone"],
      },
      {
        key: "scopeOfOperations",
        label: STAGE1_ALL_LABELS["scopeOfOperations"],
      },
      {
        key: "scopeOfOperationsOther",
        label: STAGE1_ALL_LABELS["scopeOfOperationsOther"],
      },
      { key: "typeOfEntity", label: STAGE1_ALL_LABELS["typeOfEntity"] },
      {
        key: "typeOfEntityOther",
        label: STAGE1_ALL_LABELS["typeOfEntityOther"],
      },
      { key: "areaOfOperation", label: "Area of Operation" },
      {
        key: "headquartersCountry",
        label: STAGE1_ALL_LABELS["headquartersCountry"],
      },
      {
        key: "incorporationCountry",
        label: STAGE1_ALL_LABELS["incorporationCountry"],
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "hasLegalPersonality",
        label: STAGE1_ALL_LABELS["hasLegalPersonality"],
      },
      { key: "hasLegalCapacity", label: STAGE1_ALL_LABELS["hasLegalCapacity"] },
      {
        key: "canReceiveFundsDirectly",
        label: STAGE1_ALL_LABELS["canReceiveFundsDirectly"],
      },
      {
        key: "canHandleGCFCurrencies",
        label: STAGE1_ALL_LABELS["canHandleGCFCurrencies"],
      },
      {
        key: "canMaintainInterestBearingAccount",
        label: STAGE1_ALL_LABELS["canMaintainInterestBearingAccount"],
      },
      {
        key: "canUndertakeFullCycle",
        label: STAGE1_ALL_LABELS["canUndertakeFullCycle"],
      },
      {
        key: "fullCycleDescription",
        label: STAGE1_ALL_LABELS["fullCycleDescription"],
      },
      {
        key: "hasFiduciaryCapacity",
        label: STAGE1_ALL_LABELS["hasFiduciaryCapacity"],
      },
      { key: "hasESSCapacity", label: STAGE1_ALL_LABELS["hasESSCapacity"] },
      {
        key: "hasGenderCapacity",
        label: STAGE1_ALL_LABELS["hasGenderCapacity"],
      },
      {
        key: "hasMonitoringCapacity",
        label: STAGE1_ALL_LABELS["hasMonitoringCapacity"],
      },
      {
        key: "legalSupportingDocumentsFiles",
        label: STAGE1_ALL_LABELS["legalSupportingDocumentsFiles"],
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        key: "hasClimateFinanceExperience",
        label: STAGE1_ALL_LABELS["hasClimateFinanceExperience"],
      },
      {
        key: "climateFinanceOverview",
        label: STAGE1_ALL_LABELS["climateFinanceOverview"],
      },
      {
        key: "hasTrackRecordInRegion",
        label: STAGE1_ALL_LABELS["hasTrackRecordInRegion"],
      },
      {
        key: "trackRecordOverview",
        label: STAGE1_ALL_LABELS["trackRecordOverview"],
      },
      {
        key: "climateTrackRecord",
        label: STAGE1_ALL_LABELS["climateTrackRecord"],
      },
      {
        key: "intendedESSRiskCategory",
        label: STAGE1_ALL_LABELS["intendedESSRiskCategory"],
      },
      {
        key: "intendedFinancialInstruments",
        label: STAGE1_ALL_LABELS["intendedFinancialInstruments"],
      },
      { key: "fiduciaryLevel", label: STAGE1_ALL_LABELS["fiduciaryLevel"] },
      {
        key: "projectManagementLevel",
        label: STAGE1_ALL_LABELS["projectManagementLevel"],
      },
      { key: "essLevel", label: STAGE1_ALL_LABELS["essLevel"] },
      {
        key: "hasGrievanceMechanism",
        label: STAGE1_ALL_LABELS["hasGrievanceMechanism"],
      },
      {
        key: "grievanceMechanismLevel",
        label: STAGE1_ALL_LABELS["grievanceMechanismLevel"],
      },
      { key: "genderLevel", label: STAGE1_ALL_LABELS["genderLevel"] },
      { key: "monitoringLevel", label: STAGE1_ALL_LABELS["monitoringLevel"] },
      {
        key: "canEnsureDownstreamCompliance",
        label: STAGE1_ALL_LABELS["canEnsureDownstreamCompliance"],
      },
      {
        key: "canMonitorCompliance",
        label: STAGE1_ALL_LABELS["canMonitorCompliance"],
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        key: "accreditedByEUDGINTPA",
        label: STAGE1_ALL_LABELS["accreditedByEUDGINTPA"],
      },
      {
        key: "fastTrackComplianceDetails",
        label: STAGE1_ALL_LABELS["fastTrackComplianceDetails"],
      },
      {
        key: "fastTrackAccreditationFiles",
        label: STAGE1_ALL_LABELS["fastTrackAccreditationFiles"],
      },
      {
        key: "hasSubmittedFMCA",
        label: STAGE1_ALL_LABELS["hasSubmittedFMCA"],
      },
      {
        key: "hasReceivedReadinessSupport",
        label: STAGE1_ALL_LABELS["hasReceivedReadinessSupport"],
      },
      {
        key: "hasServedAsExecutingEntity",
        label: STAGE1_ALL_LABELS["hasServedAsExecutingEntity"],
      },
      {
        key: "executingEntityDetails",
        label: STAGE1_ALL_LABELS["executingEntityDetails"],
      },
      {
        key: "hasServedAsDeliveryPartner",
        label: STAGE1_ALL_LABELS["hasServedAsDeliveryPartner"],
      },
      { key: "hasEngagedInPSAA", label: STAGE1_ALL_LABELS["hasEngagedInPSAA"] },
      {
        key: "preparedForPartnerships",
        label: STAGE1_ALL_LABELS["preparedForPartnerships"],
      },
    ],
  },
];
...
export function isBooleanFieldKey(key: string): boolean {
...
export function formatStage1Value(key: string, value: unknown): string {
  ...
  if (key === "climateTrackRecord" && Array.isArray(value)) {
    return value.length > 0 ? `${value.length} project(s) listed` : "No projects listed";
  }
...
export function getAttachmentUrls(
  ...
  return getAttachments(key, data).map((item) =>
    resolveCloudinaryFileUrl(item),
  );
}
...
export function getSubmissionSummary(data: Record<string, unknown>) {
  return {
    ...
    organizationType:
      formatStage1Value("organizationType", data["organizationType"]) || "—",
    contactEmail: (data["primaryContactEmail"] as string) || "—",
    headquarters: (data["headquartersCountry"] as string) || "—",
    scope:
      formatStage1Value("scopeOfOperations", data["scopeOfOperations"]) || "—",
  };
}
